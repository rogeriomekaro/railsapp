...
RSpec.describe LikesController, :type => :controller do
  ...
  let(:valid_attributes) { 
    ...
    { user_id:1, object_type: "idea", obj_id: create(:idea).id} 
  }
  ...
  describe "POST create" do
    describe "with valid params" do
      it "create a new like" do 
        ...
        @user = create(:user)
        sign_out :user
        xhr :post, :create, { user_id: @user.id, obj_type: "Idea", obj_id: @idea.id} 
        expect(assigns(:like)).to be_a_new(Like)
  ...
  describe "DELETE destroy" do
    ...
    it "destroys the requested like" do
      ...
      sign_in @user
      @idea = create(:idea)
      @like = Like.create!(user_id: @user.id, obj_type: "Idea", obj_id: @idea.id)
      xhr :delete, :destroy, {id: @like.id}
      expect(response).to be_success
       # delete :destroy, {id: like.id}
            # delete :destroy , {id: like.id.to_i }
      # expect(response).to be_success 
      # expect {
